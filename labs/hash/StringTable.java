...
public class StringTable {
	...
	public StringTable(int nBuckets)
    {
      ...
      // TODO - implement this method
         ...
         { //fills table with empty slots
             buckets[j] = new LinkedList<Record>();
         }
     }
    ...
    {  
    	...
    	int hashcode = stringToHashCode(r.key); //Find r's hash value
    ...
    {
    	// TODO - implement this method
    	 int hashcode = stringToHashCode(key); //Find r's hash value
         int index = toIndex(hashcode);
         //å�ˆæ³•æ€§åˆ¤æ–­
    ...
    {
    	return (int) (Math.abs(hashcode)%Math.pow(2,nBuckets));
	}
